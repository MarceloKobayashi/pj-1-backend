...
class CarrinhoPedido(Base):
    ...
    produtos = relationship("CarrinhoProduto", back_populates="carrinho", cascade="all, delete-orphan")
...
class CarrinhoProduto(Base):
    ...
    carrinho_id = Column(Integer, ForeignKey('carrinho_pedido.id'), primary_key=True)
